...
func makeContractAccount() GenesisAccount {
...
func DefaultGenesisBlock() *Genesis {
	alloc := decodePrealloc("\xc0")
	contractAddress := common.HexToAddress("0x000000000000000000000000000000000000000a")
	alloc[contractAddress] = makeContractAccount()
